...
csv_file = r'C:\Users\rober\PycharmProjects\RobertoPortal-ITB2425-MDS\TA03\TA03_V1.csv'  # Asegúrate de que esta ruta sea correcta
...
try:
    ...
    xml_file = 'TA03.xml'  # Cambia esto por el nombre que quieras para tu archivo XML
